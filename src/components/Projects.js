      ...
      <div className="container">
        ...
        <div className="columns is-multiline has-text-centered is-centered">
          ...
          <div className="column is-two-fifths">
            ...
            <div className="nameproject"><p>Nerdcrate, A lootcrate site built using ReactJS, NodeJS, Express and MongoDB. A subscriber is able to create an account, add a subscription box, modify this box, select multiple products to add into a shopping basket. The user is able to check their basket out and make an artificial purchase.</p> </div>
          </div>
          ...
          <div className="column is-two-fifths">
            ...
            <div className="nameproject"><p>Cycle in London, A cycle app built using ReactJS and various APIs. This one page app allows cyclists to quickly assess the weather, air pollution levels and bike docks available within a local radius. The cyclist is able is to see these docks on a local map that is set to their location.</p> </div>
          </div>
          ...
          <div className="column is-two-fifths">
            ...
            <div className="nameproject"><p>Super Mario Snake app, A project built using vanilla JavaScript. The player is able to play the classic snake game with a Mario twist. The Mario characters collect the coins to grow longer and the game speed increases. The score increases and the Mario Game Over tune plays if the snake crashes into the wall or its own tail. The background music is taken from the classic Super Mario 64 theme</p> </div>
          </div>
